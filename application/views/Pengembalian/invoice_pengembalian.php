            ...
            <section class="content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a href="<?php echo base_url()?>pengembalian" class="btn btn-primary btn-xs">kembali</a>
                            </div>
                            <div class="box-body">
                                <h1>Invoice<?php echo $row->PeminjamanId?> <?php echo $row->StatusPeminjaman?></h1>
                                <h2></h2>
                                <h4>Tanggal Peminjaman <?php echo $row->TanggalPeminjaman?> - Tanggal Pengembalian <?php echo $row->TanggalPengembalian?></h4>
                            </div>
...
<script>
    function kembaliBuku() {
        swal({
                ...
                text: "Buku tidak bisa di kembalikan",
                type: "warning",
            ...
            function() {
                window.location.href = "<?php echo base_url() ?>peminjaman/kembalikan?rcgn=<?php echo $item->PeminjamanId ?>";
            });
    }
</script>