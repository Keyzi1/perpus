            ...
            <section class="content">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                <form action="<?php echo base_url() ?>anggota/submits" method="post">
                                    <input type="hidden" name="ids" value="<?php echo $detail->UserId ?>">
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-link" type="button" onclick="hea()">Change
                                            Password
                                        </button>
                                    ...
                                    <div style="display: none;" id="pw">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="pasword" class="form-control" name="cpassword">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_lengkap" class="form-control" value="<?php echo $detail->NamaLengkap ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="role">
                                            <option <?php if ($role == 'administrator') {
                                            ...
                                            <option <?php if ($role == 'peminjam') {
                                                        echo 'selected="selected"';
                                                    } ?> value="peminjam">peminjam
                                            </option>
                                    </div>

                                    <div class="form-group">
                                        <input type="submit" name="submit" class="btn btn-xs btn-success">
                                        <a href="<?php echo base_url() ?>anggota" class="btn btn-xs btn-primary">Kembali</a>
                                    </div>
