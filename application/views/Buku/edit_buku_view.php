            ...
            <section class="content">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                <form action="<?php echo base_url() ?>buku/submits" method="post">
                                <input type="hidden" readonly name="id" value="<?php echo $detail->BukuId ?>">
                                    <div class="form-group">
                                        <label>Judul</label>
                                        <input type="text" name="judul" value="<?php echo $detail->Judul ?>" class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label>Penulis</label>
                                        <input type="text" name="penulis" value="<?php echo $detail->Penulis ?>" class="form-control">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="tahun_terbit" value="<?php echo $detail->TahunTerbit ?>" class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label>Stok</label>
                                        <input type="number" name="stok" value="<?php echo $detail->Stok ?>" class="form-control" max="12">
                                    </div>
