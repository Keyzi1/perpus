                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <table id="example2" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php $no = 1; ?>
                                        <?php foreach ($peminjam as $peminjam_item) : ?>
                                            <tr>
                                                <td><?php echo $no ?></td>
                                                <td><?php echo $peminjam_item->Username; ?></td>
                                                <td><?php echo $peminjam_item->Judul; ?></td>
                                                <td><?php echo $peminjam_item->TanggalPeminjaman; ?></td>
                                                <td><?php echo $peminjam_item->TanggalPengembalian; ?></td>
                                                <td><?php echo $peminjam_item->StatusPeminjaman; ?></td>
                                            </tr>
                                            <?php $no++; ?>
                                        <?php endforeach; ?>
                                    </tbody>
